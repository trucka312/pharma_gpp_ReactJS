...
class ReportImportSell extends Component {
  constructor(props) {
    super(props);
    this.state = {
      txtStart: '',
  ...
  componentDidMount() {
    ...
    const params = '';
    this.props.fetchAllReportImportSell(store_code, params);
    try {
          ...
          <div id="content-wrapper" className="d-flex flex-column">
            <div id="content">
              ...
              <div className="container-fluid">
                ...
                <div className="">
                  <h4 style={{ color: '#333' }}>CHI TIẾT NHẬP - BÁN HÀNG</h4>
                  ...
                  >
                    ...
                    <p style={{ marginLeft: '4px' }}>Xuất phiếu nhập bán hàng</p>
                  </button>
                ...
                <div className="card">
                  <div className="card-header py-3">
                    ...
                    >
                      ...
                      {/* dropdown staff*/}
                      <CustomPopover buttonText="Báo cáo theo" popoverWidth="140px">
                        <select
                        ...
                        <button
                          style={{ width: '45px', background: '#f5f5f5', border: '1px solid #c4c4c4', outline: 'none',marginTop: '20px' }}
                          onClick={this.handleFilterDate}
                        >
                          Lọc
                        </button>
...
const mapDispatchToProps = (dispatch, props) => {
  return {
    fetchAllReportImportSell: (store_code, params) => {
      dispatch(reportAction.fetchReportImportSell(store_code, params));
    },
  };
};
export default connect(mapStateToProps, mapDispatchToProps)(ReportImportSell);
