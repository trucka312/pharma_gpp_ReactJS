...
class ReportRevenue extends Component {
  ...
  shouldComponentUpdate(nextProps, nextState) {
    ...
    if (this.state.txtStart !== nextState.txtStart || this.state.perPage !== nextState.perPage) {
      // recall api
    }
    return true;
  }
          ...
          <div id="content-wrapper" className="d-flex flex-column">
            <div id="content">
              ...
              <div className="container-fluid">
                ...
                <div className="">
                  <h4 style={{ color: '#333' }}>BÁO CÁO DOANH SỐ BÁN HÀNG</h4>
                  ...
                  >
                    ...
                    <p style={{ marginLeft: '4px' }}>Xuất phiếu doanh số sale</p>
                  </button>
                ...
                <div className="card">
                  <div className="card-header py-3">
                    ...
                    >
                      ...
                      {/* dropdown staff*/}
                      <CustomPopover buttonText="Nhân viên sale" popoverWidth="140px">
                        <select
                        ...
                        <button
                          style={{ width: '45px', background: '#f5f5f5', border: '1px solid #c4c4c4', outline: 'none' }}
                          onClick={this.handleFilterDate}
                        >
                          Lọc
                        </button>
                      ...
                      {/* dropdown medicine */}
                      <CustomPopover buttonText="Loại thuốc" popoverWidth="120px">
                        <select
                          value={this.state.perPage}
                          onChange={this.handlePerPageChange}
                          style={{
                      ...
                      >
                        ...
                        <input
                          class="form-control"
                          type="text"
                          placeholder="Tìm kiếm theo mã hóa đơn, tên thuốc"
                  ...
                  <div className="card-body">
                      ...
                      >
                        ...
                        <thead style={{ whiteSpace: 'nowrap' }}>
                          <tr>
                            ...
                            <th>Tên thuốc</th>
                            <th>Đơn vị tính</th>
                            <th>Số lượng bán hoàn thành</th>
                            <th>Số lượng hàng bán trả lại</th>
                    ...
                    >
                      ...
                      <select
                        value={this.state.perPage}
                        onChange={this.handlePerPageChange}
                        style={{ width: '60px', height: '30px', fontSize: '14px', outline: 'none' }}
                      >
                        <option style={{ padding: '20px' }} value={10}>
                          10
                        </option>
