...
class ReportRevenue extends Component {
  ...
  componentDidMount() {
    ...
    const params = '';
    this.props.fetchAllReportRevenue(store_code, params);
    try {
          ...
          <div id="content-wrapper" className="d-flex flex-column">
            <div id="content">
              ...
              <div className="container-fluid">
                ...
                <div className="">
                  <h4 style={{ color: '#333' }}>DOANH THU THỰC</h4>
                  ...
                  >
                    ...
                    <p style={{ marginLeft: '4px' }}>Xuất phiếu doanh thu thực</p>
                  </button>
                      ...
                      >
                        ...
                        <thead style={{ whiteSpace: 'nowrap', textAlign: 'center' }}>
                          <tr>
                            ...
                            <th scope="col">Thu tiền mặt</th>
                            <th scope="col">Thu qua Chuyển khoản/Ví/Thẻ</th>
                            <th scope="col">Doanh thu bán trực tiếp</th>
                            <th scope="col">Doanh thu bán Online/COD</th>
                            <th scope="col">Tổng VAT</th>
                            <th scope="col">Doanh thu trước giảm giá</th>
                            <th scope="col">Giảm giá </th>
                            <th scope="col">Doanh thu chưa công nợ</th>
...
const mapStateToProps = (state) => {
  return {
    reportInventory: state.reportReducers.reportRevenue,
...
const mapDispatchToProps = (dispatch, props) => {
  return {
    fetchAllReportRevenue: (store_code, params) => {
      dispatch(reportAction.fetchReportRevenue(store_code, params));
    },
  };
};
