...
class CreateImportStock extends Component {
  ...
  createImportStock = () => {
    ...
    const formData = {
      ...
      transfer_stock_items: this.state.listImportStock.map((item) => {
        return {
    ...
    this.props.createTransferStocks(store_code, branch_id, formData);
  };
  onChangeSearch = (e) => {
...
const mapDispatchToProps = (dispatch, props) => {
  return {
    ...
    createTransferStocks: (store_code, branch_id, data) => {
      dispatch(
        TransferStockAction.createTransferStocks(store_code, branch_id, data)
      );
    },
