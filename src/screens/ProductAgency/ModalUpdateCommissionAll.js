...
class ModalUpdateCommissionAll extends Component {
  constructor(props) {
    super(props);
    this.state = {
      percent_agency: "",
  ...
  onSave = () => {
    const { store_code, updateAgencyCommission, agency_type_id } = this.props;
...
export default connect(null, mapDispatchToProps)(ModalUpdateCommissionAll);
