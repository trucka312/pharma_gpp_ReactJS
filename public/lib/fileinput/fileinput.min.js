  ...
  (t = {
    ...
    dataURI2Blob: function (e) {
      ...
      return (
        ...
        d
          ? new Blob([t.hasArrayBufferViewSupport() ? n : a], { type: o })
    ...
    arrayBuffer2String: function (e) {
      ...
      var t,
        ...
        a,
        n,
        r = Array.prototype.slice.apply(new Uint8Array(e)),
        o = "",
        l = 0;
      for (t = r.length; t > l; )
        switch (((i = r[l++]), i >> 4)) {
    ...
    setOrientation: function (e, t) {
      ...
      for (o += 2, i = r.byteLength; i - 2 > o; )
        switch (((a = r.getUint16(o)), (o += 2), a)) {
          case 65505:
    ...
    (i = function (i, a) {
      ...
      (n.$element = e(i)),
        ...
        n._validate() &&
          ((n.isPreviewable = t.hasFileAPISupport()),
          (n.isIE9 = t.isIE(9)),
          (n.isIE10 = t.isIE(10)),
          (n.isPreviewable || n.isIE9) && (n._init(a), n._listen()),
    ...
    (i.prototype = {
      ...
      _init: function (i, a) {
        ...
        (s.options = i),
          ...
          (s.$caption = t.getElement(
            i,
            "elCaptionText",
            r.find(".file-caption-name")
          )),
          t.isEmpty(s.msgPlaceholder) ||
            ((n = d.attr("multiple") ? s.filePlural : s.fileSingle),
            s.$caption.attr(
              "placeholder",
              s.msgPlaceholder.replace("{files}", n)
            )),
          ...
          (s.$preview = t.getElement(
            i,
            "elPreviewImage",
            r.find(".file-preview-thumbnails")
          )),
          (s.$previewStatus = t.getElement(
            i,
            "elPreviewStatus",
            r.find(".file-preview-status")
          )),
      ...
      _initTemplateDefaults: function () {
        ...
        (i =
          ...
          (o =
            '<button type="button" class="close fileinput-remove">&times;</button>\n'),
          ...
          (_ =
            '<a href="{downloadUrl}" class="{downloadClass}" title="{downloadTitle}" download="{caption}">{downloadIcon}</a>'),
          (b =
          ...
          (O.defaults = {
            ...
            fileTypeSettings: {
              image: function (e, i) {
                return (
                  t.compare(e, "image.*") || t.compare(i, /\.(gif|png|jpe?g)$/i)
                );
              },
              html: function (e, i) {
                return (
      ...
      _initPreviewCache: function () {
        ...
        (i.previewCache = {
            ...
            return v
              ? ((n = void 0 === n ? !0 : n),
                ...
                t.isEmpty(m) ||
                  ...
                  ((o = e(document.createElement("div")).html(r)),
          ...
          footer: function (e, a, n) {
            ...
            (t.isEmpty(r.config) || t.isEmpty(r.config[e])) &&
              (r.config[e] = {}),
              (a = void 0 === a ? !0 : a);
            var o,
              l = r.config[e],
            ...
            a.previewFileExtSettings &&
              e.each(a.previewFileExtSettings, function (e, t) {
                return a.previewFileIconSettings[e] && t(i)
                  ? void (n = a.previewFileIconSettings[e])
                  : void 0;
              })),
          n
        );
      ...
      _raise: function (t, i) {
        var a = this,
          n = e.Event(t);
        if (
          (void 0 !== i ? a.$element.trigger(n, i) : a.$element.trigger(n),
      ...
      _initClickable: function () {
        ...
        a.isClickable &&
          ...
          a._handler(i, "click", function (t) {
            var n = e(t.target);
            (n.parents(".file-preview-thumbnails").length &&
              !n.parents(".file-default-preview").length) ||
            ...
            onSort: function (i) {
              ...
              for (var s = 0; s < a.initialPreviewConfig.length; s++)
                null !== a.initialPreviewConfig[s] &&
                  ((n = a.initialPreviewConfig[s].key),
                  (r = e(".kv-file-remove[data-key='" + n + "']").closest(
                    t.FRAMES
                  )),
                  r
      ...
      _initPreview: function (e) {
        ...
        return a.previewCache.count()
          ...
          : (a._clearPreview(), void (e ? a._setCaption(n) : a._initCaption()));
      },
      ...
      _maximizeZoomDialog: function () {
        ...
        i.addClass("file-zoom-fullscreen"),
          ...
          r && r.length && ((l = r.outerHeight(!0) - r.height()), (o -= l)),
      ...
      _mergeAjaxCallback: function (e, t, i) {
        var a,
          n = this,
          r = n.ajaxSettings,
          o = n.mergeAjaxCallbacks;
        "delete" === i &&
          ((r = n.ajaxDeleteSettings), (o = n.mergeAjaxDeleteCallbacks)),
          (a = r[e]),
          o && "function" == typeof a
            ? "before" === o
              ? (r[e] = function () {
          ...
          void 0 !== a
            ? n
              ? ((f = a.attr("data-fileindex")),
                ...
                (m.uploadCache.append = r))
              : ((l = m.previewCache.add(c, p[0], u[0], r)),
      ...
      _uploadSingle: function (i, a) {
        ...
        (v.formdata = h),
          v.showPreview &&
            ((r = e("#" + w + ":not(.file-preview-initial)")),
          ...
          0 === g ||
            ...
            (o = function () {
              ...
              v.fileBatchCompleted &&
                (o && o.content && (r = o.content.length),
                setTimeout(function () {
            ...
            (c = function (o) {
              (n = v._getOutData(o)),
                ...
                v.showPreview &&
                  (r.hasClass("file-preview-success") ||
                    (v._setThumbStatus(r, "Loading"),
                ...
                e.extend(!0, C, n),
                v._abort(C) && (o.abort(), v._setProgressCancelled());
            }),
            (p = function (o, s, c) {
          ...
          0 !== d &&
            ...
            (i = function (i) {
              ...
              l.showPreview &&
                ...
                l._abort(a) && (i.abort(), l._setProgressCancelled());
            }),
            (a = function (i, a, n) {
              ...
              t.isEmpty(i) || t.isEmpty(i.error)
                ? (l._raise("filebatchuploadsuccess", [r]),
                  o(),
                  l.showPreview
                    ? (d.each(function () {
                        var t = e(this);
              ...
              l._showUploadError(o, n, "filebatchuploaderror"),
                ...
                l.showPreview &&
                  ...
                  l._setProgress(
                    101,
                    l.$progress,
                    l.msgAjaxProgressError.replace("{operation}", r)
                  ));
            }),
          ...
          r._abort(o) ||
            ((e = function (e) {
              ...
              r._raise("filebatchpreupload", [t]),
                ...
                (o.data = t),
                (o.xhr = e),
                r._abort(o) && (e.abort(), r._setProgressCancelled());
            }),
            (i = function (e, i, a) {
              var n = r._getOutData(a, e);
              t.isEmpty(e) || t.isEmpty(e.error)
                ? (r._raise("filebatchuploadsuccess", [n]),
                  r._clearFileInput(),
                  r._initUploadSuccess(e),
                  r._setProgress(101))
                : r._showUploadError(e.error, n, "filebatchuploaderror");
            }),
            (a = function () {
              r.unlock(),
                r._clearFileInput(),
                r._raise("filebatchuploadcomplete", [
                  r.filestack,
                  r._getExtraData(),
                ]);
            }),
            (n = function (e, t, i) {
              ...
              (o.data = a),
                ...
                r._setProgress(
                  101,
                  r.$progress,
                  r.msgAjaxProgressError.replace("{operation}", n)
                );
            }),
        ...
        "init_" === n.substring(0, 5) &&
          ...
          a.getFrames().each(function () {
            ...
            "init_" === i.substring(0, 5) &&
              ...
              i > n && (i--, t.attr("data-fileindex", "init_" + i)));
          }),
            ...
            i._handler(s, "click", function () {
              return (
                ...
                l !== !1 && i._validateMinCount()
                  ? ((n = d.hasClass("file-preview-error")),
                    t.cleanMemory(d),
      ...
      _readFiles: function (i) {
        ...
        var a,
          ...
          y = function (t, r, o, l) {
            ...
            n._previewDefault(r, o, !0),
              ...
              (n.isError = n.isAjaxUpload
                ? n._showUploadError(t, d)
                : n._showError(t, c)),
        ...
        (n.loadedImages = []),
          ...
          (a = function (x) {
            if ((t.isEmpty(r.attr("multiple")) && (f = 1), x >= f))
              return (
                n.isAjaxUpload && n.filestack.length > 0
                  ? n._raise("filebatchselected", [n.getFileStack()])
                  : n._raise("filebatchselected", [i]),
                s.removeClass("file-thumb-loading"),
                void d.html("")
              );
            var T,
            ...
            if (0 === Z.length)
              return (
                (S = n.msgInvalidFileName.replace(
                  "{name}",
                  t.htmlEncode(R.name)
                )),
                void y(S, R, B, x)
            ...
            if (!t.isEmpty(g) && t.isArray(g)) {
              ...
              if (0 === W)
                return (
                  (S = n.msgInvalidFileType.setTokens({ name: Z, types: q })),
                  void y(S, R, B, x)
                );
            }
            return 0 !== W ||
                ...
                ? !C && N > b
                  ...
                  : (o.length && void 0 !== FileReader
                      ? ((D = O(R.type, Z)),
                        ...
                        (l.onload = function (i) {
                          ...
                          return (
                            ...
                            0 === K &&
                            ((a = new Uint8Array(i.target.result)),
                            ...
                            (d = t.getMimeType(r, "", "")),
                            t.isEmpty(d) &&
                              ((s = t.arrayBuffer2String(l.result)),
                              (d = t.isSvg(s)
                                ? "image/svg+xml"
                                : t.getMimeType(r, s, R.type))),
                            (o = { name: Z, type: d }),
                            (D = O(d, "")),
                            (z = M(d, "")),
                            ($ = L(d, "")),
                      ...
                      : (n._previewDefault(R, B),
                        ...
                        n._raise("fileloaded", [R, B, x, l])),
                    void n.addToStack(R))
                : (n.isAjaxUpload && n.addToStack(R),
                  setTimeout(function () {
                    a(x + 1), n._updateFileDetails(f);
                  }, 100),
                  void n._raise("fileloaded", [R, B, x, l]))
              : ((S = n.msgInvalidFileExtension.setTokens({
                  name: Z,
                  extensions: _,
                })),
                void y(S, R, B, x));
        ...
        i.isClickable &&
          ...
          i.isAjaxUpload &&
            ...
            (0 === a.find(t.FRAMES).length &&
              ...
              a.prepend(
                '<div class="' + i.dropZoneTitleClass + '">' + n + "</div>"
              ),
      ...
      _refreshUploadButton: function (e, t) {
        var i = this,
          ...
          o = n.uploadTitle;
        a.length &&
          (t && ((r = n.uploadRetryIcon), (o = n.uploadRetryTitle)),
      ...
      _checkDimensions: function (e, i, a, n, r, o, l) {
        ...
        !t.isEmpty(m) &&
          ...
          (p = "Small" === i ? d >= m : m >= d),
          p ||
            ((s = u["msgImage" + o + i].setTokens({ name: r, size: m })),
          ...
          m
            .one("load", function () {
              (l = u.width()),
                ...
                (d = window.piexif ? window.piexif.load(r) : null),
                c.loadedImages.push({
                  ind: f,
                  img: m,
                  thumb: u,
      ...
      _change: function (i) {
        ...
        var r,
          ...
          p = a.isAjaxUpload,
          u = c ? i.originalEvent.dataTransfer.files : n.get(0).files,
          f = a.filestack.length,
          m = t.isEmpty(n.attr("multiple")),
          v = m && f > 0,
          g = 0,
          h = a._getFileIds(),
          w = function (t, i, n, r) {
      ...
      upload: function () {
        ...
        if (r.isAjaxUpload && !r.isDisabled && r._isFileSelectionValid(o)) {
          ...
          if (((n = r.filestack.length), (r.hasInitData = !1), !r.uploadAsync))
    ...
    (e.fn.fileinput.defaults = {
      ...
      errorCloseButton:
        '<button type="button" class="close kv-error-close">&times;</button>',
      slugCallback: null,
      dropZoneEnabled: !0,
